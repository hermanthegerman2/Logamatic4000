...
class LogamaticGateway extends IPSModule
{
    ...
    public function ForwardData($JSONString)
    {
        ...
        if ($this->ReadPropertyBoolean("Logging")) IPS_LogMessage('Logamatic Gateway -> RS232 or TCP Port', str2hex(utf8_decode($data->Buffer)));
    ...
    {
        $data = json_decode($JSONString);
        if ($this->ReadPropertyBoolean("Logging")) IPS_LogMessage('RS232 or TCP Port -> Logamatic Gateway', str2hex(utf8_decode($data->Buffer)));
