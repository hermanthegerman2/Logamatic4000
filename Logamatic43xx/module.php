...
class Logamatic43xx extends IPSModule
{
    ...
    public function ForwardData($JSONString)
    {
        ...
        IPS_LogMessage('Logamatic 43xx -> Gateway', bin2hex(utf8_decode($data)));
        $id = IPS_SendDataToParent( $this->InstanceID, json_encode(Array('DataID' => '{0D923A14-D3B4-4F44-A4AB-D2B534693C35}', "Buffer" => utf8_encode($data)))); // Daten senden
        return $id;
    }
