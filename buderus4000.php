...
function Buderus ($typ, $offset, $value)
    ...
    $Buderus[9][-1] = array ("Heizkreis 3 / einstellbare Werte", "64");
        ...
        $Buderus[9][19] = array ("", 58);
        $Buderus[9][58] = array ("", "");
        $Buderus[9][59] = array ("Heizsystem", "HKHeizsystem", "kein Heizsystem", "Heizkörper", "Konvektor", "Fussboden", "Fusspunkt", "konstant", "Raumregler", "EIB");
        $Buderus[9][60] = array ("", 61);
        $Buderus[9][61] = array ("", "");
        $Buderus[9][62] = array ("Absenkart Ferien", "HKAbsenkart", "Abschalt (Frostschutz bleibt aktiv)", "Reduziert", "Raumhalt", "Außenhalt");
        $Buderus[9][63] = array ("Umschalttemperatur für Absenkart Außenhalt bei Ferienbetrieb", "Temp", "1", "°C");
        $Buderus[9][64] = array ("", "");
