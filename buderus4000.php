...
function Buderus ($typ, $offset, $value)
    ...
    $Buderus[7][-1] = array ("Heizkreis 1 / einstellbare Werte", "65");
        ...
        $Buderus[7][65] = array ("", "");
    $Buderus[8][-1] = array ("Heizkreis 2 / einstellbare Werte", "65");
        $Buderus[8][0] = array ("", "");
        ...
        $Buderus[8][4] = array ("Betriebswerte", "HKBetriebsart", "Manuell Nacht", "Manuell Tag", "Automatik");
        $Buderus[8][5] = array ("", 16);
        $Buderus[8][16] = array ("", "");
        $Buderus[8][17] = array ("Auslegungstemperatur Heizkreis", "Temp", "1", "°C");
        $Buderus[8][18] = array ("", 56);
        $Buderus[8][56] = array ("", "");
        ...
        $Buderus[8][58] = array ("", 62);
        $Buderus[8][62] = array ("", "");
        $Buderus[8][63] = array ("Absenkart Ferien", "HKAbsenkart", "Abschalt (Frostschutz bleibt aktiv)", "Reduziert", "Raumhalt", "Außenhalt");
    ...
    $Buderus[9][-1] = array ("Heizkreis 3 / einstellbare Werte", "65");
        ...
        $Buderus[9][4] = array ("Betriebswerte", "HKBetriebsart", "Manuell Nacht", "Manuell Tag", "Automatik");
    ...
    $Buderus[10][-1] = array ("Heizkreis 4 / einstellbare Werte", "65");
        ...
        $Buderus[10][4] = array ("Betriebswerte", "HKBetriebsart", "Manuell Nacht", "Manuell Tag", "Automatik");
        $Buderus[10][5] = array ("", 16);
        $Buderus[10][16] = array ("", "");
        $Buderus[10][17] = array ("Auslegungstemperatur Heizkreis", "Temp", "1", "°C");
        $Buderus[10][18] = array ("", 56);
        $Buderus[10][56] = array ("", "");
    ...
    $Buderus[12][-1] = array ("Warmwasser / einstellbare Werte", "45");
        ...
        $Buderus[12][4] = array ("Uhrzeit an der die thermische Desinfektion starten soll", "Zeit", "1", "Std");
        $Buderus[12][5] = array ("", 6);
        $Buderus[12][6] = array ("", "");
    ...
    $Buderus[17][-1] = array ("Kanal 1", "3");
        ...
        $Buderus[17][2] = array ("Party", "Zeit", "1", "Std");
        $Buderus[17][3] = array ("Ferien", "Zeit", "1", "Tage");
    $Buderus[18][-1] = array ("Kanal 2", "3");
        $Buderus[18][0] = array ("festgelegte Schaltprogramme", "Bit", "Eigen", "Frueh", "Spaet", "Nachmittag", "Mittag", "Single", "Senior", "LEER");
        $Buderus[18][1] = array ("Pause", "Zeit", "1", "Std");
        $Buderus[18][2] = array ("Party", "Zeit", "1", "Std");
        $Buderus[18][3] = array ("Ferien", "Zeit", "1", "Tage");
    $Buderus[19][-1] = array ("Kanal 3", "3");
        $Buderus[19][0] = array ("festgelegte Schaltprogramme", "Bit", "Eigen", "Frueh", "Spaet", "Nachmittag", "Mittag", "Single", "Senior", "LEER");
        $Buderus[19][1] = array ("Pause", "Zeit", "1", "Std");
        $Buderus[19][2] = array ("Party", "Zeit", "1", "Std");
        $Buderus[19][3] = array ("Ferien", "Zeit", "1", "Tage");
    $Buderus[20][-1] = array ("Kanal 4", "3");
        $Buderus[20][0] = array ("festgelegte Schaltprogramme", "Bit", "Eigen", "Frueh", "Spaet", "Nachmittag", "Mittag", "Single", "Senior", "LEER");
        $Buderus[20][1] = array ("Pause", "Zeit", "1", "Std");
        $Buderus[20][2] = array ("Party", "Zeit", "1", "Std");
        $Buderus[20][3] = array ("Ferien", "Zeit", "1", "Tage");
    $Buderus[21][-1] = array ("Kanal 5", "3");
        $Buderus[21][0] = array ("festgelegte Schaltprogramme", "Bit", "Eigen", "Frueh", "Spaet", "Nachmittag", "Mittag", "Single", "Senior", "LEER");
    ...
    $Buderus[22][-1] = array ("Heizkreis 5 / einstellbare Werte", "65");
        ...
        $Buderus[22][4] = array ("Betriebswerte", "Bit", "Manuell Nacht", "Manuell Tag", "Automatik");
        $Buderus[22][18] = array ("Auslegungstemperatur Heizkreis", "Temp", "1", "°C");
        $Buderus[22][57] = array ("Heizsystem", "Bit", "kein Heizsystem", "Heizkörper", "Konvektor", "Fussboden", "Fusspunkt", "konstant", "Raumregler", "EIB");
        $Buderus[22][63] = array ("Absenkart Ferien", "Bit", "Abschalt (Frostschutz bleibt aktiv)", "Reduziert", "Raumhalt", "Außenhalt");
        $Buderus[22][64] = array ("Umschalttemperatur für Absenkart „Außenhalt“ bei Ferienbetrieb", "Temp", "1", "°C");
    $Buderus[23][-1] = array ("Kanal 6", "3");
        $Buderus[23][0] = array ("festgelegte Schaltprogramme", "Bit", "Eigen", "Frueh", "Spaet", "Nachmittag", "Mittag", "Single", "Senior", "LEER");
    ...
    $Buderus[24][-1] = array ("Heizkreis 6 / einstellbare Werte", "65");
        ...
        $Buderus[24][4] = array ("Betriebswerte", "Bit", "Manuell Nacht", "Manuell Tag", "Automatik");
        $Buderus[24][18] = array ("Auslegungstemperatur Heizkreis", "Temp", "1", "°C");
        $Buderus[24][57] = array ("Heizsystem", "Bit", "kein Heizsystem", "Heizkörper", "Konvektor", "Fussboden", "Fusspunkt", "konstant", "Raumregler", "EIB");
        $Buderus[24][63] = array ("Absenkart Ferien", "Bit", "Abschalt (Frostschutz bleibt aktiv)", "Reduziert", "Raumhalt", "Außenhalt");
        $Buderus[24][64] = array ("Umschalttemperatur für Absenkart „Außenhalt“ bei Ferienbetrieb", "Temp", "1", "°C");
    $Buderus[25][-1] = array ("Kanal 7", "3");
        $Buderus[25][0] = array ("festgelegte Schaltprogramme", "Bit", "Eigen", "Frueh", "Spaet", "Nachmittag", "Mittag", "Single", "Senior", "LEER");
    ...
    $Buderus[26][-1] = array ("Heizkreis 7 / einstellbare Werte", "65");
        ...
        $Buderus[26][4] = array ("Betriebswerte", "Bit", "Manuell Nacht", "Manuell Tag", "Automatik");
        $Buderus[26][18] = array ("Auslegungstemperatur Heizkreis", "Temp", "1", "°C");
        $Buderus[26][57] = array ("Heizsystem", "Bit", "kein Heizsystem", "Heizkörper", "Konvektor", "Fussboden", "Fusspunkt", "konstant", "Raumregler", "EIB");
        $Buderus[26][63] = array ("Absenkart Ferien", "Bit", "Abschalt (Frostschutz bleibt aktiv)", "Reduziert", "Raumhalt", "Außenhalt");
        $Buderus[26][64] = array ("Umschalttemperatur für Absenkart „Außenhalt“ bei Ferienbetrieb", "Temp", "1", "°C");
    $Buderus[27][-1] = array ("Kanal 8", "3");
        $Buderus[27][0] = array ("festgelegte Schaltprogramme", "Bit", "Eigen", "Frueh", "Spaet", "Nachmittag", "Mittag", "Single", "Senior", "LEER");
    ...
    $Buderus[28][-1] = array ("Heizkreis 8 / einstellbare Werte", "65");
        ...
        $Buderus[28][4] = array ("Betriebswerte", "Bit", "Manuell Nacht", "Manuell Tag", "Automatik");
        $Buderus[28][18] = array ("Auslegungstemperatur Heizkreis", "Temp", "1", "°C");
        $Buderus[28][57] = array ("Heizsystem", "Bit", "kein Heizsystem", "Heizkörper", "Konvektor", "Fussboden", "Fusspunkt", "konstant", "Raumregler", "EIB");
        $Buderus[28][63] = array ("Absenkart Ferien", "Bit", "Abschalt (Frostschutz bleibt aktiv)", "Reduziert", "Raumhalt", "Außenhalt");
        $Buderus[28][64] = array ("Umschalttemperatur für Absenkart „Außenhalt“ bei Ferienbetrieb", "Temp", "1", "°C");
    $Buderus[29][-1] = array ("Kanal 9", "3");
        $Buderus[29][0] = array ("festgelegte Schaltprogramme", "Bit", "Eigen", "Frueh", "Spaet", "Nachmittag", "Mittag", "Single", "Senior", "LEER");
        $Buderus[29][1] = array ("Pause", "Zeit", "1", "Std");
