...
function Buderus ($typ, $offset, $value)
    ...
    $Buderus[7][-1] = array ("Heizkreis 1 / einstellbare Werte", "63");
        ...
        $Buderus[7][5] = array ("Byte 6", "Temp", "0.5", "°C");
        $Buderus[7][6] = array ("Byte 7", "Temp", "0.5", "°C");
        $Buderus[7][7] = array ("Byte 8", "Temp", "0.5", "°C");
        $Buderus[7][8] = array ("Byte 9", "Temp", "0.5", "°C");
        $Buderus[7][9] = array ("Byte 10", "Temp", "0.5", "°C");
        $Buderus[7][10] = array ("Byte 11", "Temp", "0.5", "°C");
        $Buderus[7][11] = array ("Byte 12", "Temp", "0.5", "°C");
        $Buderus[7][12] = array ("Byte 13", "Temp", "0.5", "°C");
        $Buderus[7][13] = array ("Byte 14", "Temp", "0.5", "°C");
        $Buderus[7][14] = array ("Byte 15", "Temp", "0.5", "°C");
        $Buderus[7][15] = array ("Byte 16", "Temp", "0.5", "°C");
        $Buderus[7][16] = array ("Auslegungstemperatur Heizkreis", "Temp", "1", "°C");
        $Buderus[7][17] = array ("Byte 18", "Temp", "0.5", "°C");
        $Buderus[7][18] = array ("Byte 19", "Temp", "0.5", "°C");
        $Buderus[7][19] = array ("Byte 20", "Temp", "0.5", "°C");
        $Buderus[7][20] = array ("", 54);
        $Buderus[7][54] = array ("", "");
