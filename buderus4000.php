...
function Buderus ($typ, $offset, $value)
    ...
    $Buderus[9][-1] = array ("Heizkreis 3 / einstellbare Werte", "64");
        ...
        $Buderus[9][19] = array ("", 55);
        $Buderus[9][55] = array ("", "");
        $Buderus[9][56] = array ("Heizsystem", "HKHeizsystem", "kein Heizsystem", "Heizkörper", "Konvektor", "Fussboden", "Fusspunkt", "konstant", "Raumregler", "EIB");
        $Buderus[9][57] = array ("", 61);
        $Buderus[9][61] = array ("", "");
