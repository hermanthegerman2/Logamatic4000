...
function Buderus ($typ, $offset, $value)
    ...
    $Buderus[11][-1] = array ("Außenparameter");
        $Buderus[11][0] = array ("", "");
    $Buderus[12][-1] = array ("Warmwasser / einstellbare Werte", "42");
        $Buderus[12][0] = array ("", "");
        ...
        $Buderus[12][10] = array ("", "");
        $Buderus[12][11] = array ("Betriebsart Warmwasser", "HKBetriebsart", "Manuell Nacht", "Manuell Tag", "Automatik");
        $Buderus[12][12] = array ("", 15);
        $Buderus[12][15] = array ("", "");
        $Buderus[12][16] = array ("Zirkulationspumpenläufe pro Stunde", "Modul", "ständig aus (läuft nur bei Einmalladung)", "ständig an", "2", "3", "4", "5", "6", "7");
        $Buderus[12][17] = array ("", 20);
        $Buderus[12][20] = array ("", "");
        $Buderus[12][21] = array ("Betriebsart Zirkulation", "HKBetriebsart", "Manuell Nacht", "Manuell Tag", "Automatik");
        $Buderus[12][22] = array ("", 40);
        $Buderus[12][40] = array ("", "");
        $Buderus[12][41] = array ("Uhrzeit zu der die tägliche Aufheizung gestartet wird", "ZeitHours", "1", "Std");
        $Buderus[12][42] = array ("", "");
