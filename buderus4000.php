...
function Buderus ($typ, $offset, $value)
    ...
    $Buderus[7][-1] = array ("Heizkreis 1 / einstellbare Werte", "63");
        ...
        $Buderus[7][5] = array ("Byte 6", "Temp", "1", "°C");
        $Buderus[7][6] = array ("Byte 7", "Temp", "1", "°C");
        $Buderus[7][7] = array ("Byte 8", "Temp", "1", "°C");
        $Buderus[7][8] = array ("Byte 9", "Temp", "1", "°C");
        $Buderus[7][9] = array ("Byte 10", "Temp", "1", "°C");
        $Buderus[7][10] = array ("Byte 11", "Temp", "1", "°C");
        $Buderus[7][11] = array ("Byte 12", "Temp", "1", "°C");
        $Buderus[7][12] = array ("Byte 13", "Temp", "1", "°C");
        $Buderus[7][13] = array ("Byte 14", "Temp", "1", "°C");
        $Buderus[7][14] = array ("Byte 15", "Temp", "1", "°C");
        $Buderus[7][15] = array ("Byte 16", "Temp", "1", "°C");
        $Buderus[7][16] = array ("Auslegungstemperatur Heizkreis", "Temp", "1", "°C");
        $Buderus[7][17] = array ("Byte 18", "Temp", "1", "°C");
        $Buderus[7][18] = array ("Byte 19", "Temp", "1", "°C");
        $Buderus[7][19] = array ("Byte 20", "Temp", "1", "°C");
        $Buderus[7][20] = array ("", 52);
        $Buderus[7][52] = array ("Byte 53", "Temp", "1", "°C");
        $Buderus[7][53] = array ("Byte 54", "Temp", "1", "°C");
        $Buderus[7][54] = array ("Byte 55", "Temp", "1", "°C");
        $Buderus[7][55] = array ("Heizsystem", "HKHeizsystem", "kein Heizsystem", "Heizkörper", "Konvektor", "Fussboden", "Fusspunkt", "konstant", "Raumregler", "EIB");
        $Buderus[7][56] = array ("Byte 57", "Temp", "1", "°C");
        $Buderus[7][57] = array ("Byte 58", "Temp", "1", "°C");
        $Buderus[7][58] = array ("Byte 59", "Temp", "1", "°C");
        $Buderus[7][59] = array ("Byte 60", "Temp", "1", "°C");
        $Buderus[7][60] = array ("Byte 61", "Temp", "1", "°C");
        $Buderus[7][61] = array ("Absenkart Ferien", "HKAbsenkart", "Abschalt (Frostschutz bleibt aktiv)", "Reduziert", "Raumhalt", "Außenhalt");
        $Buderus[7][62] = array ("Umschalttemperatur für Absenkart Außenhalt bei Ferienbetrieb", "Temp", "1", "°C");
        $Buderus[7][63] = array ("", "");
